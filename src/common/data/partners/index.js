...
export const aboutData = {
  ...
  text1:
    "Πείτε μας για την επιχείρησή σας και ένας από τους συνεργάτες της Urbanfit θα επικοινωνήσει μαζί σας για τη δημιουργία της προσαρμοσμένης καρτέλας σας.",
...
export const faq = {
  slogan: "Συχνές Ερωτήσεις Συνεργατών Urbanfit",
  ...
  faqs: [
    {
      ...
      answer:
        "Απαντούμε στις ερωτήσεις σας από Δευτέρα έως Παρασκευή. Καλέστε μας στο +306988221619 ή αλλιως μπορειτε να μας στείλετε ενα email στο urbanfitgr@gmail.com και θα σας απαντήσουμε άμεσα!",
    },
    {
      id: 1,
      question:
      ...
      answer:
        "Εάν έχετε απορίες σχετικά με τη συμφωνία συνεργασίας σας, απλώς επικοινωνήστε μαζί μας είτε μέσω τηλεφώνου στο +306988221619 είτε μέσω email στο urbanfitgr@gmail.com και θα σας απαντήσουμε άμεσα! Στο μήνυμά σας, εξηγήστε το αίτημά σας όσο το δυνατόν ακριβέστερα, ώστε να μπορέσουμε να το διαβιβάσουμε στον αρμόδιο υπάλληλο το συντομότερο δυνατό. Το ερώτημά σας θα προωθηθεί στη συνέχεια στο αρμόδιο τμήμα, ώστε να λάβετε μια απάντηση το συντομότερο δυνατό.",
    },
    {
      id: 2,
