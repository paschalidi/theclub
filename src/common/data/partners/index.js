...
export const aboutData = {
  ...
  text2:
    '3. Αξιοποιήστε νέα είδη κοινού και προσεγγίστε χιλιάδες πελάτες στην περιοχή σας. Αξιοποιήστε την εφαρμογή μας για να δείτε την απόδοσή και τα κέρδη σας',
  title3: "Λάβετε κρατήσεις, πληρωθήτε.",
  text3:
