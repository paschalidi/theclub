...
export const featureData = {
  ...
  features: [
    ...
    },
    {
      ...
      description:
        "Με το Urbanfit, θα προσεγγίσετε νέες ομάδες πελατών - αθλητές πολλαπλών αθλημάτων και λάτρεις του αθλητισμού που εργάζονται στε εταίριες.",
    },
    {
      id: 3,
      icon: icon3,
    ...
    },
    {
      ...
      description:
        "Η συνεργασία με το Urbanfit είναι δωρεάν για εσάς - δεν υπάρχουν χρεώσεις.",
    },
  ],
};
