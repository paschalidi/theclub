    ...
    courses: [
      {
        ...
        text: "Hatha Yoga",
        details:
          "Εξασκήσου με τις παραδοσιακές στάσεις yoga. Η πρακτική περιλαμβάνει την αναπνοή, το σώμα και το μυαλό, και τα μαθήματα διαρκούν απο 90 έως 120 λεπτά. Δουλεύουμε pranayama, asanas και διαλογισμό",
      },
      {
      ...
      },
      {
        ...
        text: "Yin Yoga",
        details:
          "H Yin Yoga είναι ένα στυλ yoga με αργό ρυθμό. Ένα μάθημα Yin yoga αποτελείται συνήθως από μια σειρά παθητικών στάσεων που λειτουργούν κυρίως στο χαμηλότερο μέρος του σώματος - τους γοφούς, τη λεκάνη, τους εσωτερικούς μηρούς, την κάτω σπονδυλική στήλη. Αυτές οι περιοχές είναι ιδιαίτερα πλούσιες σε συνδετικούς ιστούς. Οι θέσεις κρατούνται για έως και 5 λεπτά, μερικές φορές και περισσότερο.",
      },
      {
      ...
      },
      {
        ...
        text: "Pilates mat",
        details:
          "Το Mat Pilates είναι μια πρακτική άσκησης pilates που μπορεί να γίνεται σε χαλάκι. Aυτό σημαίνει ότι δεν χρησιμοποιείται reformer. Στο μάθημα δουλεύονται στάσεις όπως σανίδες, πλευρικές σανίδες και πολλές ασκήσεις κορμού.",
      },
      {
      ...
      {
        icon: "/images/facial-treatment.svg",
        text: "Συμπληρωματικές Θεραπείες",
        details:
          "Παραδοσιακό Ταϊλανδικό μασάζ, Ταϊλανδικό μασάζ με κομπρέσες, Ολιστική θεραπεία με Έλαια, Αθλητική μάλαξη, Λεμφική μάλαξη, Shiatsu, Reiki",
      },
    ],
  },
  "stadio-sports-power": {
